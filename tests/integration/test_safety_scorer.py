...
async def main():
    ...
    try:
        async with (
            ...
            # SafetyScorer expects 'distance_miles' which RoutePlanner generates
            ...
            if "duration_minutes" not in target_route:
                dur_seconds = target_route.get("duration_seconds", 0)  # check structure
            ...
            score_result = await safety_scorer.score_route(
                target_route, driver_profile, current_conditions
            )
